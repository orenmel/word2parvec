'''
Used to pool all substitute candidates for every target type in a lexical substitution dataset
'''
import sys
...
if __name__ == '__main__':
    ...
    if ignore_mwe:
        sys.stderr.write("After discarding MWE, there are %d instances with at least one substitute.\n"  % (good_oneword_inst))        
